...
class InitialProduct(BaseModel): name: str; purchase_price: float = 0; sale_price: float = 0; stock: float = 0; category: Optional[str] = None
class BusinessIn(BaseModel): name: str = Field(min_length=2, max_length=100); type: str; currency: str = "USD"; initial_products: List[InitialProduct] = []
class SettingsIn(BaseModel):
    rif: Optional[str] = Field(default=None, max_length=20); address: Optional[str] = Field(default=None, max_length=200); phone: Optional[str] = Field(default=None, max_length=30); bcv_mode: Optional[str] = None; bcv_rate: Optional[float] = Field(default=None, gt=0); iva_enabled: Optional[bool] = None; iva_percent: Optional[float] = Field(default=None, ge=0, le=100); igtf_enabled: Optional[bool] = None; igtf_percent: Optional[float] = Field(default=None, ge=0, le=100); delivery_enabled: Optional[bool] = None; delivery_amount: Optional[float] = Field(default=None, ge=0); display_currency: Optional[str] = None; price_reference: Optional[str] = None
...
class ProductIn(BaseModel):
    name: str = Field(min_length=1, max_length=120); sku: Optional[str] = None; barcode: Optional[str] = None; category: Optional[str] = None; brand: Optional[str] = None; supplier: Optional[str] = None; purchase_price: float = Field(default=0, ge=0); sale_price: float = Field(default=0, ge=0); stock: float = Field(default=0, ge=0); min_stock: float = Field(default=5, ge=0); max_stock: Optional[float] = None; unit: str = "unidad"; base_unit: Optional[str] = None; image_url: Optional[str] = Field(default=None, max_length=2000000)
...
class SaleIn(BaseModel):
    items: List[SaleItemIn] = Field(min_length=1); payment_method: str = "efectivo"; payment_parts: List[PaymentPartIn] = []; customer_name: Optional[str] = None; customer_rif: Optional[str] = None; apply_iva: Optional[bool] = None; apply_igtf: Optional[bool] = None; apply_delivery: Optional[bool] = None; extra_charges: List[SaleChargeIn] = []
...
class PlatformPlanIn(BaseModel): name: str = Field(min_length=2, max_length=60); description: Optional[str] = Field(default=None, max_length=300); monthly_price_usd: float = Field(gt=0); active: bool = True; features: List[str] = []; entitlements: Dict[str, Any] = {}
...
class CashClosureIn(BaseModel):
    date: str = Field(min_length=10, max_length=10); opening_cash: float = Field(default=0, ge=0); counted_cash: Optional[float] = Field(default=None, ge=0); denominations: List[CashDenominationIn] = []; other_cash_in: float = Field(default=0, ge=0); other_cash_out: float = Field(default=0, ge=0); observations: Optional[str] = Field(default=None, max_length=1000); use_previous_closing: bool = False
