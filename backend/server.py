...
async def startup():
    ...
    defaults=[
        {"name":"Básico","description":"Para negocios que comienzan a digitalizar su operación.","monthly_price_usd":4.98,"active":True,"features":["Inventario","Ventas","Compras","Dashboard"]},
        {"name":"Negocio","description":"Para negocios que necesitan más control y análisis de su operación.","monthly_price_usd":8.98,"active":True,"features":["Todo Básico","Finanzas","Reportes","Equipo"]},
        {"name":"Pro","description":"Para negocios que quieren aprovechar todas las capacidades de CuadraApp.","monthly_price_usd":14.98,"active":True,"features":["Todo Negocio","IA","Reportes avanzados","Proyección","Funciones premium"]}
    ]
