...
async def finances_summary(user: dict = MANAGER):
    ...
    sales = await db.sales.find({"business_id": bid}, {"_id": 0}).to_list(50000); expenses = await db.expenses.find({"business_id": bid}, {"_id": 0}).to_list(20000); purchases = await db.purchases.find({"business_id": bid}, {"_id": 0}).to_list(20000)
